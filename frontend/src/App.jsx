...
function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 relative flex items-center justify-center p-4 overflow-hidden">
      ...
      <div className="absolute top-0 -left-4 size-96 bg-pink-300 opacity-30 blur-[100px]" />
      <div className="absolute bottom-0 -right-4 size-96 bg-cyan-300 opacity-30 blur-[100px]" />
